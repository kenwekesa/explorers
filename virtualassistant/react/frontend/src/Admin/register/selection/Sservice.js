...
const Sservice = ({ selectedServices, onChange }) => {
  ...
  return (
    <div>
      <select value={selectedOption} onChange={handleOptionChange} className="S_selectoptions">
        <option value="Select admin industry portfolio...">Select admin industry portfolio...</option>
