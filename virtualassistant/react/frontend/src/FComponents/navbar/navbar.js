...
const [navbarBackground, setNavbarBackground] = useState('transparent');
  ...
  return (
    <nav  className="themainnavbar" style={{ backgroundColor: navbarBackground }}>
      ...
      <div  className={`main-navbar-links ${isMobileMenuOpen ? 'open' : ''}`}>
        <Link to="/" onClick={scrollToTop} className="navlinkse">Home</Link>
        <Link to="/services" onClick={scrollToTop} className="navlinkse">Services</Link>
        <Link to="/prices" onClick={scrollToTop} className="navlinkse">Pricing</Link>
        <Link to="/about" onClick={scrollToTop} className="navlinkse">About</Link>
        <Link to="/industries" onClick={scrollToTop} className="navlinkse">Industries</Link>
        <Link to="/contact" onClick={scrollToTop} className="navlinkse">Contact</Link>
        <div className="button button-main-navbar">
        <Link to="/login" className="ton" onClick={scrollToTop} >Login</Link>
        </div>
       </div>
       <div className="main-navbar-button">
        <Link to="/login" className="ton" onClick={scrollToTop} >Login</Link>
        </div>
       <div className="menu-toggle" onClick={toggleMobileMenu}>
        &#9776;
