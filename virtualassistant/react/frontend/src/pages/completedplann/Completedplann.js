    ...
    <div className='orderhistory'>
      ...
      <div className="orderhistory-content">
        <div className="topContainer orderTopContainer">
          <p className='addnewplan'>Completed <span>plans</span></p>
        </div>
          ...
          <table>
            ...
            <tbody>
              {isLoading ? ( // Show loading indicator if loading is true
                ...
                <tr>
                  <td colSpan="6">No completed plans available please come back later!</td>
                </tr>
              ) : (
