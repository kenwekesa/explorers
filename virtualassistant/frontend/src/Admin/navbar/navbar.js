  ...
  return (
      <div className='adminnavbar'>
          ...
          <div className='adminnavbarbottom'>
            ...
            <div className="logo adminlogo">
            <Link to="/clients" className='adminlink'><p className='adminuser' ><img src={plans} loading="lazy" alt="Logo" /><span>New Plan</span></p></Link>
              </div>
            <div className="logo adminlogo">
            <Link to="/assistants" className='adminlink'><p className='adminuser' ><img src={assistants} loading="lazy" alt="Logo" /><span>Order History</span></p></Link>
              </div>
            <div className="logo adminlogo">
            <Link to="/plans" className='adminlink'><p className='adminuser' ><img src={plans} loading="lazy" alt="Logo" /><span>Add Funds</span></p></Link>
              </div>
            <div className="logo adminlogo">
            <Link to="/messages" className='adminlink'><p className='adminuser' ><img src={message} loading="lazy" alt="Logo" /><span>Support</span></p></Link>
              </div>
            <div className="logo adminlogo">
            <Link to='/funds' className='adminlink'><p className='adminuser' ><img src={cash} loading="lazy" alt="Logo" /><span>Service List</span></p></Link>
              </div>
            <div className="logo adminlogo">
            <Link to="/register" className='adminlink'><p className='adminuser adminuserlast' ><img src={admin} loading="lazy" alt="Logo" /><span>Faqs</span></p></Link>
              </div>
            {/* <div className="logo adminlogo">
