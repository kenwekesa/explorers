...
import "./Inducardcssfirst.css"
const Industrycardfirst = () => {
 const [hovered, setHovered] = React.useState(false);
  ...
  return (
    <div className="industry-card-stack">
      <div
        className="industry-card industry-bottom-card"
      ...
      <animated.div
        className="industry-card industry-top-card"
        style={topCardProps}
        onMouseEnter={() => setHovered(true)}
        onMouseLeave={() => setHovered(false)}
      >
...
export default Industrycardfirst