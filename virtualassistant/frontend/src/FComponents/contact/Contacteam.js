     ...
     <div className='mteam'>
        <div className='mtpfirst'>
            ...
            <p className='mtpe'>Wondering how to access a virtual assistant? <br></br>
              ...
              <div className='teamsocialimages'>
               <a className='ctimg'><img src={fb} alt="logo" className='teamimages' loading="lazy" /> </a>
               <a className='ctimg'><img src={inst} alt="logo" className='teamimages' loading="lazy" /> </a> 
               <a className='ctimg'><img src={tweet } alt="logo" className='teamimages' loading="lazy"/> </a>    
            </div>
        </div>
        <div>
