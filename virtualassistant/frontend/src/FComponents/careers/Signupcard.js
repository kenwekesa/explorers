   ...
   <div className='cardsignupone'>
      <p className='cardmainsip'>All  fields are required</p>
         <form onSubmit={handleSubmit}>
            ...
            <div className='signcardcontent'>
              <p>What is your area of specialization ? <span>(required)</span></p>
              {/* <input className='signcardiinput' required/> */}
              <div>
                  <Sservice />
              </div>
             ...
             <div className='signcardcontent'>
              <p>Provide your Degree(Master/Phd/Certificate) <span>(required)</span></p>
              <input type="file" className='signcardiinput_file' autoComplete required/>
            </div>
            <div className='signcardcontent'>
              <p>Provide your transcripts <span>(required)</span></p>
              <input type="file" className='signcardiinput_file' autoComplete required/>
            </div>
            <div className='signcardcontent'>
